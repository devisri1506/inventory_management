  ...
  useEffect(() => {
    if (Object.keys(formErrors).length === 0 && isSubmit) {
      ...
      if (
        ...
        setUserState(Admin);
        navigate("./././public/adminpage.html", { replace: true });
      } 
      else if (
        ...
        navigate("./././public/employeepage.html", { replace: true });
      } 
      else if (
        user.email === developer.email &&
        user.password === developer.password
      ) {
        // Simulate successful login
        alert("Login successful!");
        setUserState(developer);
        navigate("./././public/developerPage.html", { replace: true });
      } 
